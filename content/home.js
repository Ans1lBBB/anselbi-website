module.exports = {
  "zh-tw": {
    ...
    ruby_title: "小主私密日記-經期排卵備孕日曆・老中醫古法調理・無廣告",
    ruby_sub: "養生閣典籍摘錄｜可上鎖手札・週期智能提醒",
    ruby_desc:
      "經期排卵備孕日曆，搭配可上鎖每日筆記與老中醫養生閣典籍專區。摘錄四部中醫經典，依週期階段提供起居、穴位與飲食參考。全程無廣告。",
    aios_title: "艾奧斯海",
    aios_sub: "合併潮印，喚醒女神",
    aios_desc:
  ...
  "zh-cn": {
    ...
    ruby_title: "小主私密日记-经期排卵备孕日历・老中医古法调理・无广告",
    ruby_sub: "养生阁典籍摘录｜可上锁手札・周期智能提醒",
    ruby_desc:
      "经期排卵备孕日历，搭配可上锁每日笔记与老中医养生阁典籍专区。摘录四部中医经典，依周期阶段提供起居、穴位与饮食参考。全程无广告。",
    aios_title: "艾奥斯海",
    aios_sub: "合并潮印，唤醒女神",
    aios_desc:
